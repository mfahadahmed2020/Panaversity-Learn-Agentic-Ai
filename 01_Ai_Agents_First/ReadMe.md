...
https://github.com/aurelio-labs/cookbook/blob/main/gen-ai/openai/agents-sdk-intro.ipynb
 ...
 ایجنٹ کا سورس کوڈ چیک کریں:

https://openai.github.io/openai-agents-python/ref/agent/

 دو اے . سسٹم پرامپٹ ایجنٹ کلاس میں بطور ہدایات موجود ہے؟ آپ اسے قابل کال کے طور پر کیوں سیٹ کر سکتے ہیں؟

 دو بی . لیکن یوزر پرامپٹ کو رنر کے رن میتھڈ میں پیرامیٹر کے طور پر پاس کیا جاتا ہے اور طریقہ ایک کلاس میتھڈ ہے ۔

 یہ چیک کریں: https://openai.github.io/openai-agents-python/ref/run/

  رنر کلاس کا مقصد کیا ہے؟ 

 پائیتھون میں جنرک کیا ہیں؟
 
 ہم اسے ٹی سیاق و سباق؟ کے لیے کیوں استعمال کرتے ہیں؟

 نوٹ: سمجھنے کے لیے سورس کوڈ کو دیکھیں ۔

  یہاں اہم تفصیلات ہیں:
  
 بنیادی تصورات: ڈیزائن میں سادگی کی طاقت

 جو چیز واقعی ایجنٹوں SDK کو الگ کرتی ہے وہ ہے اس کی سادگی اور طاقت کا سوچا سمجھا توازن۔ SDK چار بنیادی پرائمیٹوز کے ارد گرد بنایا گیا ہے:

 ایجنٹس:

 یہ لینگویج ماڈلز (LLMs) ہیں جو مخصوص ہدایات، ٹولز تک رسائی (جیسے ویب سرچ یا فائل کی بازیافت)، اور یہاں تک کہ حفاظتی محافظوں کے ساتھ پہلے سے ترتیب دیے گئے ہیں۔ ایجنٹ     جوابات پیدا کر سکتے ہیں اور فیصلہ کر سکتے ہیں کہ سیاق و سباق کی بنیاد پر کس ٹول کو کال کرنا ہے۔

 ہینڈ آف:

 ایس ڈی کے کی طاقتور خصوصیات میں سے ایک ایجنٹوں کے درمیان کام سونپنے کی صلاحیت ہے۔ اگر ایک ایجنٹ کو کوئی مسئلہ درپیش ہوتا ہے یا اس کے ڈومین سے باہر کوئی قدم ہوتا ہے،   تو وہ اس کام کو دوسرے، خصوصی ایجنٹ کے حوالے کر سکتا ہے۔

 گارڈریلز:
 
 یہ بلٹ ان سیفٹی چیک ہیں جو ان پٹ اور آؤٹ پٹس کی توثیق کرتے ہیں، اس بات کو یقینی بناتے ہیں کہ ایجنٹ متعین پیرامیٹرز کے اندر کام کرتے ہیں اور آٹومیشن سے وابستہ خطرات کو کم     کرتے ہیں ۔

 ٹریسنگ اور مشاہدہ: 

 ایس ڈی کے میں انٹیگریٹڈ ٹریسنگ کی صلاحیتیں شامل ہیں جو ڈویلپرز کو ایجنٹ کے اعمال کے بہاؤ کو دیکھنے اور ڈیبگ کرنے کی اجازت دیتی ہیں۔ یہ پیچیدہ کام کے بہاؤ کی نگرانی اور       کارکردگی کو بہتر بنانے کے لیے خاص طور پر مفید ہے ۔

 یہ کم سے کم نقطہ نظر ایس ڈی کے کو نئے آنے والوں کے لیے قابل رسائی بناتا ہے جبکہ تجربہ کار ڈویلپرز کو جدید ترین نظام بنانے کے لیے کافی لچک فراہم کرتا ہے۔ بلٹ ان ٹریسنگ کی    صلاحیتیں ایجنٹ کے کام کے بہاؤ کو تصور کرنا، ڈیبگ کرنا اور جانچنا آسان بنا کر ترقی کے تجربے کو مزید بڑھاتی ہیں۔

    کلیدی خصوصیات

   
 پائیتھون کا پہلا ڈیزائن:
    
 ایس ڈی کے کو قدرتی طور پر پائیتھون کے ساتھ ضم کرنے کے لیے ڈیزائن کیا گیا ہے۔ ڈویلپرز تیزی سے ایجنٹوں کو ترتیب دے سکتے ہیں، ان ٹولز کی وضاحت کر سکتے ہیں جنہیں وہ استعمال  کر سکتے ہیں (یہاں تک کہ پائیتھون فنکشنز کو کال ایبل ٹولز میں تبدیل کر سکتے ہیں)، اور کام کے فلو کو بغیر کسی سخت سیکھنے کے منحنی خطوط کی ضرورت کے ساتھ جوڑ سکتے ہیں۔

 بلٹ ان ایجنٹ لوپ:
 
 جب آپ SDK کے ساتھ ایجنٹ چلاتے ہیں، تو یہ خود بخود ایک لوپ میں داخل ہو جاتا ہے جہاں یہ :
 
 ایل ایل ایم کو ایک اشارہ بھیجتا ہے۔ 

 چیک کرتا ہے کہ آیا کسی ٹولز کو طلب کرنے کی ضرورت ہے ۔
 
 ایجنٹوں کے درمیان ہینڈ آف ہینڈل کرتا ہے ۔

 اس وقت تک دہرایا جاتا ہے جب تک کہ کوئی حتمی آؤٹ پٹ نہ بن جائے ۔

 انٹرآپریبلٹی:

 اگرچہ اوپن اے آئی کے اپنے ماڈلز اور نئے جوابات اے پی آئی کے ساتھ بغیر کسی رکاوٹ کے کام کرنے کے لیے بنایا گیا ہے، ایجنٹس ایس ڈی کے کسی بھی ماڈل فراہم کنندہ کے ساتھ کام      کرنے کے لیے  کافی لچکدار ہے جو چیٹ کی تکمیل اے پی آئی فارمیٹ ۔ فارمیٹ کو سپورٹ کرتا ہے۔

آسان ملٹی ایجنٹ ورک فلوز:

 یہ پیچیدہ نظاموں کی تخلیق کی اجازت دیتا ہے جہاں، مثال کے طور پر، ایک ایجنٹ تحقیق کر سکتا ہے جبکہ دوسرا کسٹمر سپورٹ کے کاموں کو سنبھالتا ہے—ہر ایجنٹ مشترکہ مقصد کو حاصل    کرنے کے لیے مل کر کام کرتا ہے ۔

 حقیقی دنیا کی درخواستیں :
 
 انٹرپرائزز SDK کا استعمال AI سے چلنے والے اسسٹنٹ بنانے کے لیے کرتے ہیں جو مثال کے طور پر ویب سرچ کے ذریعے ریئل ٹائم ڈیٹا کھینچ سکتے ہیں، فائل سرچ کا استعمال کرتے ہوئے    اندرونی دستاویزات تک رسائی حاصل کر سکتے ہیں، اور یہاں تک کہ کمپیوٹر انٹرفیس کے ساتھ بات چیت کر سکتے ہیں۔ یہ AI ایجنٹوں کو صنعتوں جیسے کسٹمر سپورٹ، قانونی تحقیق، فنانس      اور مزید کے لیے عملی بنا رہا ہے ۔

 کیوں یہ اہمیت رکھتا ہے ۔

 زیادہ تر آرکیسٹریشن منطق کا خلاصہ کرتے ہوئے جو پہلے دستی طور پر یا ایڈہاک انضمام کے ذریعے ہینڈل کیا گیا تھا، ایجنٹس SDK ترقی کے عمل کو آسان بناتا ہے، جس سے آپ اپنی درخواست کی بنیادی خصوصیات کو بنانے پر توجہ مرکوز کر سکتے ہیں۔ کم تجریدوں اور ازگر پر مبنی نقطہ نظر کے ساتھ، پیچیدہ ایجنٹ ورک فلو کو برقرار رکھنا، بڑھانا اور ڈیبگ کرنا آسان ہے۔

خلاصہ یہ کہ OpenAI ایجنٹس SDK خود مختار، ملٹی ایجنٹ سسٹم بنانے کے لیے بلڈنگ بلاکس فراہم کرتا ہے جو مختلف ایجنٹوں کی طاقتوں کو مربوط کرکے پیچیدہ کاموں سے نمٹ سکتا ہے — AI کو حقیقی معنوں میں ایکشن اور پروڈکشن کے لیے تیار کرنے کے لیے ایک ضروری قدم ہے۔

مزید گہرائی سے تکنیکی تفصیلات اور مثالوں کے لیے، آپ سرکاری دستاویزات کو تلاش کر سکتے ہیں اور GitHub پر مخزن کو چیک کر سکتے ہیں:

https://github.com/openai/openai-agents-python

OpenAI کے ایجنٹوں SDK کے ساتھ AI ایجنٹوں کی تعمیر: ایک ابتدائی رہنما
ابتدائی جائزے

OpenAI کے ایجنٹوں SDK کو کھولنا: AI ایجنٹوں کے مستقبل میں ایک تکنیکی گہرا غوطہ

ڈویلپرز OpenAI ایجنٹس SDK کو اس کی سادگی اور طاقت کے لیے اعلیٰ نمبر دے رہے ہیں۔ کمیونٹی کے تاثرات کا ایک سنیپ شاٹ یہ ہے: 

استعمال میں آسانی اور ازگر - پہلا نقطہ نظر: 
بہت سے ڈویلپرز اس بات کی تعریف کرتے ہیں کہ SDK میں بہت کم تجریدات ہیں اور اسے ازگر کے لیے ڈیزائن کیا گیا ہے۔ اس کا مطلب ہے کہ آپ بغیر کسی زبردست سیکھنے کے منحنی خطوط کے فوری طور پر ایجنٹوں کو ترتیب دے سکتے ہیں، ٹولز کی وضاحت کر سکتے ہیں اور ورک فلو کو آرکیسٹریٹ کر سکتے ہیں۔ سبق اور ابتدائی رہنما اس بات کی تعریف کرتے ہیں کہ کس طرح فریم ورک پیچیدہ ملٹی ایجنٹ سیٹ اپ کو کسی ایسی چیز میں بدل دیتا ہے جو "صرف کام کرتی ہے۔" 

ہموار ملٹی ایجنٹ ورک فلوز: 
ڈویلپرز بلٹ ان ہینڈ آفس اور ٹریسنگ خصوصیات کے بارے میں پرجوش ہیں۔ خصوصی ایجنٹوں کے درمیان بغیر کسی رکاوٹ کے کاموں کو منتقل کرنے اور پھر ان تعاملات کو بصری طور پر ٹریک اور ڈیبگ کرنے کی صلاحیت کو پچھلے، زیادہ دستی طریقوں کے مقابلے گیم چینجر کے طور پر دیکھا جاتا ہے۔ 

کمیونٹی اور اوپن سورس اپنانا: 
GitHub کے ذخیرے میں پہلے سے ہی تقریباً 2,000 ستارے اور متعدد فورک موجود ہیں، جو کمیونٹی کی مضبوط دلچسپی اور شراکت کی نشاندہی کرتے ہیں۔ صارفین فعال طور پر مثالوں کا اشتراک کر رہے ہیں، مسائل کی رپورٹنگ کر رہے ہیں، اور اضافہ تجویز کر رہے ہیں- ایک حوصلہ افزا علامت کہ SDK مفید اور حقیقی دنیا کی ضروریات کی بنیاد پر تیار ہو رہا ہے۔ 

حقیقی دنیا کا اثر: 
انفرادی منصوبوں کے علاوہ، انٹرپرائز سطح کے جائزے (مثال کے طور پر، Box جیسی کمپنیوں سے) تجویز کرتے ہیں کہ جب دوسرے ٹولز (جیسے ویب اور فائل کی تلاش) کے ساتھ مل کر، SDK اصل وقت کی بیرونی معلومات کے ساتھ اندرونی ڈیٹا کو ضم کرنا آسان بناتا ہے۔ اس جامع نقطہ نظر کو حقیقی طور پر خود مختار AI نظام کی تعمیر کے لیے اہم سمجھا جا رہا ہے۔

مجموعی طور پر، ڈویلپرز اور ابتدائی اپنانے والے SDK کے بارے میں بہت مثبت ہیں، مینوئل پرامپٹ انجینئرنگ کو کم کرنے، مزید خود مختار ایجنٹوں کو فعال کرنے، اور اس کے ٹریسنگ ٹولز کے ذریعے واضح، قابل عمل تاثرات فراہم کرنے کے لیے اس کی تعریف کرتے ہیں۔ کمیونٹی کی طرف سے جوش و خروش اور بڑھتی ہوئی انٹرپرائز دلچسپی اس بات کا اشارہ ہے کہ یہ فریم ورک مستقبل کی AI ایپلی کیشنز کے لیے سنگ بنیاد بن سکتا ہے۔
